...
def monthDays(year, month):
    ...
    monthDaysComun = (0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31)
    days = monthDaysComun[month]
    monthDaysLeap = (0, 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31)
    days = monthDaysLeap[month]

    return monthDaysLeap[month] if isLeapYear(year) else monthDaysComun[month]
