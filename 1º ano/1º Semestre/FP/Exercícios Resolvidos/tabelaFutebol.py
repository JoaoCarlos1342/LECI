...
def main():
    ...
    print("Tabela de equipas ordenada por número de pontos decresecente")
    ...
    print("Tabela ordenada por ordem decrescente da diferença GM-GS")
    ...
    tab = sorted(tabela, key=lambda reg: (pontos, reg[4]-reg[5]), reverse=True)
    printTabela(tab)
