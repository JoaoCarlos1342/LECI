...
// J. Madeira
//
// The Sub-Set Sum Problem --- Combinatorial Problem
//
// Finding a solution using Exhaustive Search
//
...
// Solving a Sub-Set Sum problem instance through Exhaustive Search
// Return the solution as a binary number
